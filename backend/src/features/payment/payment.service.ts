...
let plansCache: { data: Awaited<ReturnType<typeof prisma.subscriptionPlan.findMany>>; expiresAt: number } | null = null;
...
export async function listPlans() {
    ...
    plansCache = { data: plans, expiresAt: Date.now() + 30_000 };
    return plans;
}
